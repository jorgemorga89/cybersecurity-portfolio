...
Transitioning from Technical Support to Cybersecurity

---

### About Me

IT professional with over 15 years of experience in technical support, incident management, and team coordination (Tier 2 / Duty Manager). Currently transitioning my career into **Cybersecurity**, with a strong focus on **Security Operations Center (SOC)** roles.

I am building a solid foundation through structured courses, official certifications, and hands-on practice, with emphasis on networking, SIEM tools, log analysis, and incident investigation.
...
- Network Fundamentals (IPv4/IPv6, Ethernet, Routers)
...
*"Continuous learning is the key to building a strong career in Cybersecurity."*
